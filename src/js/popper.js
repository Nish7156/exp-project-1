!(function (e, t) {
  ...
  function v(e, t) {
    ...
    return (
      (n ? t.contains(f) : t === f && "BODY" !== f.nodeName) && (c = l(c, t)), c
    );
  }
  function b(e) {
  ...
  function y(e, t, n, r) {
    ...
    if ("viewport" === r) a = b(s);
      ...
      "scrollParent" === r
        ? ((f = i(o(e))),
          "BODY" === f.nodeName && (f = window.document.documentElement))
        : (f = "window" === r ? window.document.documentElement : r);
      var u = v(f, s);
  ...
  function L(e) {
    var t = window.getComputedStyle(e),
      ...
      o = { width: e.offsetWidth + r, height: e.offsetHeight + n };
    return o;
  }
  function T(e) {
  ...
  function H(e, t, n, r) {
    ...
    var o = i(e);
    return (
      D(o, "scroll", n.updateBound, n.scrollParents),
      (n.scrollElement = o),
      (n.eventsEnabled = !0),
      n
    );
  ...
  function q(e, t, n, r, o) {
    ...
    return t.setAttribute("x-placement", a), R(t, { position: "absolute" }), n;
  }
  function K(e, t) {
    var n = t.x,
      r = t.y,
    ...
    var s = void 0 !== i ? i : t.gpuAcceleration,
      ...
      v = void 0;
    if (
      ((v = "bottom" === d ? -p.height + l.bottom : l.top),
      (m = "right" === c ? -p.width + l.right : l.left),
      s && h)
    )
  ...
  function G(e, t) {
    ...
    var o = e.placement.split("-")[0],
      ...
      c = f ? "bottom" : "right",
      h = L(n)[p];
    s[c] - h < a[l] && (e.offsets.popper[l] -= a[l] - (s[c] - h)),
      s[l] + h > a[c] && (e.offsets.popper[l] += s[l] + h - a[c]);
    var g = s[l] + s[p] / 2 - h / 2,
      v = r(e.instance.popper, "margin" + u).replace("px", ""),
      b = g - m(e.offsets.popper)[l] - v;
    return (
      (b = Math.max(Math.min(a[p] - h, b), 0)),
      (e.arrowElement = n),
      (e.offsets.arrow = {}),
      (e.offsets.arrow[l] = Math.round(b)),
      (e.offsets.arrow[d] = ""),
      e
    );
  }
    ...
    return (
      a.forEach(function (s, f) {
        ...
        var p = e.offsets.popper,
          ...
          l = Math.floor,
          d =
            ("left" === r && l(p.right) > l(u.left)) ||
            ("right" === r && l(p.left) < l(u.right)) ||
            ("top" === r && l(p.bottom) > l(u.top)) ||
            ("bottom" === r && l(p.top) < l(u.bottom)),
          c = l(p.left) < l(n.left),
    ...
    var o = t.priority,
      ...
      s = {
        primary: function (e) {
          var n = i[e];
          return (
            i[e] < r[e] && !t.escapeWithReference && (n = Math.max(i[e], r[e])),
            ge({}, e, n)
          );
        },
        secondary: function (e) {
          ...
          return (
            i[e] > r[e] &&
              ...
              (o = Math.min(i[n], r[e] - ("right" === e ? i.width : i.height))),
            ge({}, n, o)
          );
        },
      };
  ...
  function te(e) {
    ...
    if (r) {
      var o = e.offsets,
        ...
        f = s ? "left" : "top",
        p = s ? "width" : "height",
        u = { start: ge({}, f, i[f]), end: ge({}, f, i[f] + i[p] - a[p]) };
  ...
  for (
    var oe = ["native code", "[object MutationObserverConstructor]"],
      ie = function (e) {
  ...
  var ue = ae && ie(window.MutationObserver),
    ...
    ce = function () {
      return (
        void 0 === de && (de = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        de
      );
    },
    he = function (e, t) {
    ...
    Oe = {
      shift: { order: 100, enabled: !0, fn: te },
    ...
    xe = (function () {
      function e(t, r) {
        ...
        he(this, e),
          ...
          (this.options = ve({}, e.Defaults, i)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = t.jquery ? t[0] : t),
          (this.popper = r.jquery ? r[0] : r),
          (this.options.modifiers = {}),
          Object.keys(ve({}, e.Defaults.modifiers, i.modifiers)).forEach(
            function (t) {
              o.options.modifiers[t] = ve(
                {},
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function (e) {
              return ve({ name: e }, o.options.modifiers[e]);
            })
            .sort(function (e, t) {
  ...
  return (
    (xe.Utils = ("undefined" != typeof window ? window : global).PopperUtils),
    (xe.placements = be),
    (xe.Defaults = Ee),
    xe
  );
